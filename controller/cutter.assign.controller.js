...
export async function registerCutterAssign (req, res, next)  {
    try {
      ...
      let counterModel = await getCounterModel(companyId);
        ...
        const { date, productId, stockID, employID, assignedQuantity ,godownId} = req.body;
        ...
        const addToAssign = new assignCutterModel({ date:date,batchID:seqId,productId:productId,stockID:stockID,employID:employID,assignedQuantity:assignedQuantity,godownId:godownId});
